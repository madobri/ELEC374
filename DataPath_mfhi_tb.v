...
module DataPath_mfhi_tb;
  ...
  initial begin
    ...
    @(posedge clk); 
	 ...
	 fromInPort = 32'b00000001100100000000000000000010;
	 inport_in = 1;
    ...
    @(posedge clk); 
	 ...
	 //T2
    @(posedge clk); 
	 Inout = 0; IRin = 0; fromInPort = -32'd5; inport_in = 1;
	 ...
	 @(posedge clk); 
	 Rout = 0; Yin = 0; Grb = 0; Cout = 1; opcode = 5'b01111;
	 #50
	 Zin = 1;
	 
	 @(posedge clk);
	 Zin = 0; Cout = 0; zhighout = 1; HIin = 1; 
	 
	 @(posedge clk); //mfhi
	 zhighout = 0; HIin = 0; Gra = 1; HIout = 1; Rin = 1;
	 #30
    $stop;
