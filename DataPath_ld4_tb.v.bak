...
module DataPath_ld2_tb;
  ...
  initial begin
    ...
    @(posedge clk); 
	 ...
	 fromInPort = 32'b00000011000100000000000000111111;
	 inport_in = 1;
    ...
    @(posedge clk); 
	 ...
	 //T2
    @(posedge clk); 
	 Inout = 0; IRin = 0; fromInPort = 32'h00000078; inport_in = 1;
	 
	 //T2
	 @(posedge clk);
	 inport_in = 0; Inout = 1; Grb = 1; Rin = 1;
	 
	 //T3
	 @(posedge clk);
	 Inout = 0; Rin = 0; Rout = 1; Yin = 1;
	 
	 //T4
    @(posedge clk); 
	 Yin = 0; Rout = 0; Grb = 0; Cout = 1; opcode = 5'b00011;
	 Zin = 1; 
	 
	 //T5
    @(posedge clk); 
    Cout <= 0; Zin <= 0; zlowout <= 1; MARin = 1; 
	 
	 //T6
    @(posedge clk); 
    zlowout = 0; MARin = 0; read = 1; MDRin = 1;
	 
	 //T7
	 @(posedge clk); 
	 read = 0; MDRin = 0; Gra = 1; MDRout = 1; Rin = 1;
	 #30
    $stop;
