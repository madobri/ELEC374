...
module DataPath_addi_tb;
  ...
  initial begin
    ...
    @(posedge clk); 
	 ...
	 fromInPort = 32'b00000011001010000111111111111001;
	 inport_in = 1;
    ...
    @(posedge clk); 
	 ...
	 //T2
    @(posedge clk); 
	 Inout = 0; IRin = 0; fromInPort = 32'd8; inport_in = 1;
	 ...
	 //T4
    @(posedge clk); 
	 Yin = 0; Rout = 0; Gra = 0; Cout = 1; opcode = 5'b00011;
	 Zin = 1; 
	 
	 //T5
    @(posedge clk); 
    Cout <= 0; Zin <= 0; zlowout <= 1; Grb = 1; Rin = 1; 
