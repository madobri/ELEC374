...
module DataPath_st2_tb;
  ...
  initial begin
    ...
    @(posedge clk); 
	 ...
	 fromInPort = 32'b00000000000110000000000000110110;
	 inport_in = 1;
    ...
    @(posedge clk); 
	 ...
	 //T2
    @(posedge clk); 
	 Inout = 0; IRin = 0; fromInPort = 32'h000000B6; inport_in = 1;
	 ...
	 @(posedge clk);
	 Rout = 0; Yin = 0; Cout = 1; opcode = 5'b00011; Zin = 1;
	 
	 @(posedge clk);
	 Cout = 0; Zin = 0; zlowout = 1; MARin = 1;
	 
	 @(posedge clk);
	 zlowout = 0; MARin = 0; Rout = 1; MDRin = 1;
	 
	 @(posedge clk);
	 Rout = 0; MDRin = 0; wren = 1;
