...
module DataPath_ld1_tb;
  ...
  initial begin
    ...
    @(posedge clk); 
	 ...
	 fromInPort = 32'b00000010000000000000000000110110;
	 inport_in = 1;
    ...
    @(posedge clk); 
	 ...
	 //T3
    @(posedge clk); 
	 Inout = 0; IRin = 0; Grb = 1; BAout = 1; Rout = 1; Yin = 1; 
	 
	 //T4
    @(posedge clk); 
	 Yin = 0; Rout = 0; BAout = 0; Grb = 0; Cout = 1; opcode = 5'b00011;
	 Zin = 1; 
